        ...
        <section className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          <div className="col-span-3 lg:col-span-2">
            <section className="w-full bg-[#f9ceff] relative aspect-video">
              ...
              <div className="w-[67.6%] relative translate-y-[32.2%] mx-auto h-[66.1111%] overflow-y-scroll modern-scrollbar">
                <Image
          ...
          <div className="lg:col-span-2 bg-[#DAF85E] aspect-video">
            <section className="bg-transparent relative aspect-video">
              <Image
                ...
                alt="Macbook mockup"
                className="absolute z-10 pointer-events-none"></Image>
              <div className="w-[67.67%] relative translate-y-[41%] mx-auto h-[62.1111%] overflow-y-scroll modern-scrollbar">
                <Image
        ...
        <div>
          <section className="bg-transparent relative aspect-video">
            <Image
              ...
              alt="Macbook mockup"
              className="absolute z-10 pointer-events-none"></Image>
            <div className="w-[67.6%] relative translate-y-[39.95%] mx-auto h-[62.5111%] overflow-y-scroll modern-scrollbar">
              <Image
                src="/proud-zebra/landing-page.png"
                width={2160}
                height={12310}
        ...
        <div className="">
          <section className="w-full relative aspect-video">
            <Image
              ...
              alt="Macbook mockup"
              className="absolute z-10 pointer-events-none"></Image>
            <div className="w-[67.6%] relative translate-y-[32.2%] mx-auto h-[66.2111%] overflow-y-scroll modern-scrollbar">
              <Image
                src="/proud-zebra/product-page.png"
                width={1280}
                height={2249}
        ...
        <div>
          <section className="bg-transparent relative aspect-video">
            <Image
              ...
              alt="Macbook mockup"
              className="absolute z-10 pointer-events-none"></Image>
            <div className="w-[68%] relative translate-y-[40.8%] mx-auto h-[62.2111%] overflow-y-scroll modern-scrollbar">
              <Image
