          ...
          >
            <div className="w-full text-center flex flex-col items-center justify-center">
              ...
              <p className="max-w-3xl lg:text-lg text-zinc-800 mb-8 md:mb-0">
                ...
                Merchants, providing novice cannabis consumers with the
                knowledge they need to safely get high for the first time.
              </p>
            </div>

            <div className="hidden md:block w-[160rem] aspect-square left-1/2 translate-y-[5rem] group-hover:blur-[200px] -translate-x-1/2 blur-[100px] rounded-full relative bg-[radial-gradient(circle_at_center,_var(--tw-gradient-stops))] to-[#FAFFD1] from-[#A1FFCE] opacity-30 group-hover:opacity-50 transition-all "></div>
