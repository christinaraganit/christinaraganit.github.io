      ...
      <section className="px-6 max-w w-full flex items-center flex-col text-center">
        ...
        <div className="grid gap-6 text-left">
          ...
          <a
            ...
            <div className="hidden md:block w-[160rem] aspect-square left-1/2 translate-y-[5rem] group-hover:blur-[200px] -translate-x-1/2 blur-[100px] rounded-full relative bg-[radial-gradient(circle_at_center,_var(--tw-gradient-stops))] to-[#FF2BDF] from-[#2BFFFF] opacity-30 group-hover:opacity-60 transition-all "></div>
          ...
          <a
            ...
            <div className="hidden md:block w-[160rem] aspect-square left-1/2 translate-y-[5rem] group-hover:blur-[200px] -translate-x-1/2 blur-[100px] rounded-full relative bg-[radial-gradient(circle_at_center,_var(--tw-gradient-stops))] to-[#c471ed] from-[#F27121] opacity-20 group-hover:opacity-30 transition-all "></div>
          ...
          <a
            ...
            <div className="hidden md:block w-[160rem] aspect-square left-1/2 translate-y-[5rem] group-hover:blur-[200px] -translate-x-1/2 blur-[100px] rounded-full relative bg-[radial-gradient(circle_at_center,_var(--tw-gradient-stops))] to-[#92FE9D] from-[#00C9FF] opacity-20 group-hover:opacity-30 transition-all "></div>
